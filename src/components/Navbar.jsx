      ...
      <nav className="flex lg:px-[42px] lg:py-[30px] py-[33px] px-[30px]  p-0 justify-between items-center text-[var(--color-primary-600)]">
        ...
        <div className="flex gap-[8.27px] justify-center items-center">
          <Link to="/"><img
            ...
            alt="logo-sm"
            className="lg:hidden flex w-[114.14px] h-auto object-contain"
          />
          
          </Link>
          <Link to="/">
          <img
            src="https://raw.githubusercontent.com/hexschool/webLayoutTraining1st/refs/heads/master/student-week1/logo-all-dark.svg"
            alt="logo-lg"
            className="hidden lg:flex lg:w-[219.49px] h-auto w-[114.14px]"
          />
          </Link>
        </div>
        ...
        <div className="flex gap-[79px]">
          ...
          <Link to="/shopping">
            <img
              src={cartImg}
              alt="cart"
              style={{ cursor: "pointer" }} // 可選，讓滑鼠變手指
            />
          </Link>
        </div>
      </nav>
