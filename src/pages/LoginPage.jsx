...
export default function LoginPage() {
  return (
    <main className="flex flex-col lg:flex-row-reverse  w-full lg:py-[60px] lg:px-[122px] justify-center items-center">
      <h1 className="lg:hidden py-[30px]  w-full flex justify-center items-center bg-primary-600 h1-text text-white">
        會員登入
      </h1>
      {/* 社群帳號 */}
      <div className="flex w-full lg:w-[390px] p-[30px] lg:flex-col lg:gap-[36px] bg-primary-100 justify-center items-center">
        <h2 className="hidden lg:flex  text-primary-400 font-light text-[24px]">
          —— 連結社群帳號 ——
        </h2>
        <div className="w-full flex lg:flex-col lg:gap-4  lg:py-[17px]">
          <div className="w-full flex justify-center items-center py-5 px-[13px] lg:border-0 border-1 border-primary-100  bg-white hover:shadow-lg transition ">
            <img src={fb} alt="fb" />
          </div>
          <div className="w-full flex justify-center items-center py-5 px-[13px] lg:border-0 border-1 border-primary-100  bg-white hover:shadow-lg transition ">
      ...
      <div className="flex flex-col w-full lg:w-[390px]">
        <div className="flex flex-col p-[30px] gap-4 justify-center bg-primary-600 w-full ">
          <h1 className="hidden py-[30px]  w-full lg:flex justify-center items-center bg-primary-600 h1-text text-white">
            會員登入
          </h1>
          <div className="flex items-center gap-3 bg-primary-100 text-primary-400 py-[14px] px-5 shadow-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
              fill="currentColor"
              className="bi text-primary-600"
              viewBox="0 0 16 16"
            >
              <path
                d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 
          ...
          <div className="flex items-center gap-4 bg-primary-100 text-primary-400 py-[14px] px-5 shadow-md">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
