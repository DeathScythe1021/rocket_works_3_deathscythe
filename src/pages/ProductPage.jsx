  ...
  return (
    <>
      <main className="flex flex-col lg:px-13  pb-[30px]">
        {/* banner */}
        <section
          className="bg-cover bg-center  h-[277px] pr-[30px] pt-[30px] w-full flex justify-end "
        ...
        <section className="flex flex-col lg:justify-between w-full lg:flex-row lg:gap-5 lg:py-[60px] ">
          <div className="flex flex-col  w-full lg:w-[300px]">
            <div className="flex justify-center items-center h-[65px] bg-primary-700 btn-text text-primary-100">
              甜點類別
            </div>
            <Button variant="third" className="bg-primary-100">
              所有甜點（48）
            </Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px] px-[30px] py-[30px]">
            ...
            <div className="w-full flex justify-center items-center  lg:col-start-3  md:col-start-2  ">
              <Button
                variant="fourth"
                className="hover:bg-primary-400 w-[60px] h-[60px] border-1 border-primary-100 money-text flex justify-center items-center"
              >
                <img src={left} />
              </Button>
              <Button className="font-semibold bg-primary-600 text-primary-100  h-[60px] border-1 border-primary-100 money-text">
                1
              </Button>
              <Button
                variant="fourth"
                className="h-[60px] border-1 border-primary-100 money-text"
              >
                2
              </Button>
              <Button
              ...
              <Button
                variant="fourth"
                className="hover:bg-primary-400 h-[60px] border-1 border-primary-100 money-text flex justify-center items-center"
              >
                <img src={right} />
              </Button>
            </div>
