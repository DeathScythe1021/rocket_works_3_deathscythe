...
function ShippingPage() {
  return (
    <main className="flex lg:py-[65px] lg:px-[122px] gap-5 ">
      <section className=" bg-primary-600 w-full flex flex-col justify-between items-center ">
        <div className="p-[30px] w-full">
          <div className="flex w-full justify-between items-center pb-[30px]">
            <h1 className="h1-text ">運送</h1>
            <div className="flex relative ">
                <div className="w-[170px] h-[1px] bg-primary-400"></div>
                <div className="flex justify-center items-center  absolute top-[-10px] w-5 h-5 border-1 border-primary-100 rounded-full bg-primary-600 ">
                    <div className="flex   w-3 h-3 bg-primary-100 rounded-full"></div>
                </div>
                <div className="absolute top-[-10px] right-0 w-5 h-5 border-1 border-primary-400 rounded-full bg-primary-600 hover:"></div>
                <div className="absolute top-[-10px] right-[75px] w-5 h-5 border-1 border-primary-400 rounded-full bg-primary-600"></div>
            </div>
          </div>
          {/* 個資 */}
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col w-full gap-2">
              <p className="name-text text-white">電話</p>
              <div className="flex justify-start text w-full py-[17px] px-[20px] bg-primary-100 text-primary-400">
                0912-345-678
              </div>
            </div>
            <div className="flex gap-[9px] w-full">
              <div className="flex flex-col w-full gap-2">
                <p className="name-text text-white">地址</p>
        ...
        <div className="flex flex-col justify-center items-center gap-4   w-[300px] border-1 border-primary-100 ">
          ...
          <div className="flex flex-col  w-full py-4 px-5">
            ...
            <div className="flex w-full justify-between ">
              ...
              <p className="money-text text-primary-400 ">
                NT$ 3,000
              </p>
            </div>
          </div>
